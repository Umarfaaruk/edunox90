  ...
  return (
    <>
      <style>{`
        ...
        .shiny-cta {
          --shiny-cta-bg: hsl(214, 91%, 18%);
          --shiny-cta-bg-subtle: hsl(214, 60%, 14%);
          --shiny-cta-fg: hsl(204, 100%, 88%);
          --shiny-cta-highlight: hsl(212, 39%, 50%);
          --shiny-cta-highlight-subtle: hsl(204, 100%, 88%);
